...
@Component({
  selector: 'qui-textarea',
  templateUrl: './qui-textarea.component.html',
  styleUrls: ['./qui-textarea.component.scss']
})
export class QuiTextareaComponent extends QuiBaseControl<any> implements AfterContentInit {
